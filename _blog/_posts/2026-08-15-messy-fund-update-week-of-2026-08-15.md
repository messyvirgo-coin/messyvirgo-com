...
fundUpdateSnapshot: "2026-08-15"
permalink: /updates/2026/08/messy-fund-update-week-of-2026-08-15/index.html
---

<!-- NOT a blog article: excluded from collections.blog; listed only under collections.fundUpdates and /updates/ URLs. -->
<!-- Body rendered from _blog/_snapshots/2026-08-15-messy-fund-update.snapshot.json via fund-update-post.njk (vnext-2026-07-24) -->
